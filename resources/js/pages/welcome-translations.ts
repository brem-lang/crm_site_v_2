...
const en: Translation = {
    ...
    signup: {
        ...
        errors: {
            ...
            invalidExact:
                'Enter a valid {n}-digit phone number for this country.',
            invalidRange:
...
const fr: Translation = {
    ...
    signup: {
        ...
        subtitle:
            'Démarrez votre parcours de trading IA en moins de 30 secondes',
    ...
    process: {
        badge: 'Processus',
        heading:
            "De l'ouverture du compte à la première allocation en quatre étapes",
        steps: [
            {
